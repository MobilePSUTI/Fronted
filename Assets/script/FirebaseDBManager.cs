...
//        {
//            Debug.LogWarning($"[FirebaseDBManager] Instance already exists on {_instance.gameObject.name}, destroying this component");
//            Destroy(this); // Уничтожаем только компонент, а не весь объект
//            return;
//        }

//        _instance = this;
//        DontDestroyOnLoad(gameObject);
//        Debug.Log($"[FirebaseDBManager] Instance set on {gameObject.name} and marked as DontDestroyOnLoad");
//    }
